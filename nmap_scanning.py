...
def get_service_to_port_map(ip_address, open_ports, colors):
    ...
    if tcp_ports:
        ...
        print(f"\n\033[1m{colors['yellow']}[#] Detecting Services on open TCP ports {colors['reset']}\033[0m [{command}]")
    ...
    if udp_ports:
        ...
        print(f"\n\033[1m{colors['yellow']}[#] Detecting Services on open UDP ports {colors['reset']}\033[0m [{command}]")
